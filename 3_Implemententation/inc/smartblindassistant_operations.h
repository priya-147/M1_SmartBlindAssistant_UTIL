/**
 * @file smartblindassistant_operations.h
 * @author Priyadharshini G
 * @brief Header file for smartblindassistant application 
 *
 */

#ifndef __SMARTBLINDASSISTANT_OPERATIONS_H__
#define __SMARTBLINDASSISTANT_OPERATIONS_H__
